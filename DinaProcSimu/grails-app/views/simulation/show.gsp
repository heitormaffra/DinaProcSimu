	...
	<body>
		...
		<div id="show-simulation" class="content scaffold-show" role="main">
			...
			<ol class="property-list simulation">
				...
				<g:if test="${simulationInstance?.file}">
				<li class="fieldcontain">
					<span id="file-label" class="property-label"><g:message code="simulation.file.label" default="File" /></span>
					
						<span class="property-value" aria-labelledby="file-label"><g:fieldValue bean="${simulationInstance}" field="file"/></span>
			...
			<g:form>
				<fieldset class="buttons">
					<g:hiddenField name="id" value="${simulationInstance?.id}" />
					<g:link class="edit" action="edit" id="${simulationInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
